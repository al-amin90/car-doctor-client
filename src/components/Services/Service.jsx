    ...
    return (
        <div className='max-w-7xl mx-auto w-[90%] md:w-[85%]'>
            <div className='text-center'>
                ...
                <h2 ></h2>
                <p className='w-2/3 mx-auto mt-3 mb-14'>the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. </p>
            </div>
